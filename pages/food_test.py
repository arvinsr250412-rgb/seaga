...
DISH_RESULTS = [
    {"name": "老坛酸菜鱼", "portrait": "清醒、敏感、真诚", "goldSentence": "够酸够辣，但也够真。", "match": ["A", "D", "EXTREME"], "description": "测出这个结果的你，灵魂里住着一个带着刺的诗人。酸菜鱼的底色是酸，正如你对世界天然的敏锐与“防备”。你总是能精准地捕捉到空气里微小的冷热变化，甚至是社交场上那些不易察觉的虚伪。人们觉得你有时显得“刺儿头”或是不合群，但那是因为你拒绝为了廉价的共鸣而稀释真实的自我。你的温柔是“无骨”的鱼肉，极其鲜嫩，却只留给穿过酸辣汤底、真正走进你心里的人。你习惯用毒舌和疏离保护内心的柔软，这种不迎合，是你对生命最后的坚持。即便身处酸楚的汤底，你仍要记得自己是一条跃龙门的鱼。"},
    {"name": "广式白斩鸡", "portrait": "纯粹、治愈、理想主义", "goldSentence": "拒绝包装，原汁原味。", "match": ["B", "EXTREME"], "description": "在这个人人都在给自己加滤镜的时代，你是一道拒绝包装的白斩鸡。你的性格里有一种近乎偏执的‘真’。你讨厌弯弯绕绕的职场政治，也不屑于在社交网络上营造虚假的人设。对你来说，好就是好，坏就是坏，这种‘原汁原味’的理想主义让你在复杂的世界里显得既孤独又珍贵。你其实很聪明，能看穿所有的套路，但你选择不参与。你的治愈感来自于这种透明性——和你相处不需要猜谜，不需要设防。你是那种即使被误解，也会选择‘不解释、只做自己’的人，因为你深知，懂你的人自然懂那份皮爽肉滑下的赤诚真心。"},
    {"name": "99%浓黑咖啡", "portrait": "冷静、虚无、深刻", "goldSentence": "所有的热闹，都与我无关。", "match": ["C", "EXTREME"], "description": "你是那个深夜里最清醒的旁观者。99%的浓苦不是生活的毒药，而是你对抗平庸的解药。你拥有一种近乎冷酷的理智，能够轻易剥离掉情感的伪装去直视事物的本质。这让你在人群中显得有些‘局外人’。你并不排斥社交，你只是觉得大部分的喧嚣都没有意义。你的孤独是主动选择的避难所，在那里你可以自由地思考生而为人的虚无与深刻。你习惯了自己消解负面情绪，不需要廉价的安慰。这种极致的独立让你拥有一种不可侵犯的尊严感。你可能看起来有点苦，但那种回甘，只有真正拥有独立灵魂的人才能品出其中的高级感。"},
    {"name": "辣子鸡丁", "portrait": "热烈、勇敢、狂欢", "goldSentence": "在废墟里，找最火热的快乐。", "match": ["D", "EXTREME"], "description": "你是一个天生的生命力泵发者。如果生活是一座废墟，你就是在那废墟上跳舞的狂欢者。辣子鸡丁的灵魂在于‘找’，正如你在琐碎平庸的日常里，总能精准地挖出那颗名为‘快乐’的小肉丁。你活得极其灿烂，甚至带点侵略性，那种灼热的能量常常让胆小的人退缩，却让志同道合的人疯狂。你讨厌温水煮青蛙的安稳，你渴望沸腾，渴望燃烧，渴望在每一场冒险中感受到心跳。即便被现实辣得流泪，你也会抹干眼泪大喊一声：‘爽！’ 这种不计后果的英勇，是你给这个灰扑扑的世界最响亮的回击。"},
    {"name": "番茄炒蛋", "portrait": "治愈、平凡、可靠", "goldSentence": "平凡生活里的唯一解药。", "match": ["A", "B", "E"], "description": "在人人都想做‘硬菜’的时代，你选择成为那个最温暖的守望者。番茄炒蛋是你灵魂的隐喻：既有对生活小遗憾的‘酸’，也有对未来小确幸的‘甜’。你拥有极强的共情能力，习惯于照顾每个人的情绪，是朋友圈里的‘定海神针’。你并不平庸，你只是在看过世间的浮躁后，选择回归那种握在手里的、热气腾腾的踏实。你拥有一种能让悲伤消融的天赋，就像这道菜总能拌匀所有人的委屈。不需要惊天动地的登场，只要你在，身边的人就会觉得：‘嗯，日子还没那么糟。’"},
    ...
    {"name": "锅包肉", "portrait": "坚硬、甜心、直率", "goldSentence": "外表倔强，内心认甜。", "match": ["B", "D", "A"], "description": "你是那种典型的‘反差萌’。锅包肉的第一口是硬的，甚至带着某种咄咄逼人的酥脆，那是你为了保护自己而穿上的厚重铠甲。你说话直接，甚至有时显得有些倔强，不肯轻易低头。但只要有人能耐心穿透那层金黄的伪装，就会发现里头包裹着一颗极其柔软、甚至有点‘认甜’的心。你是一个极度渴望被偏爱的人，虽然嘴上不说，但内心其实非常温顺。你的‘辣’和‘刚’是给世界看的，你的‘甜’和‘软’是留给家人的。这种外冷内热的特质让你拥有一种迷人的张力，让你身边的人既怕你的小脾气，又离不开你的小温暖。"},
    {"name": "麻婆豆腐", "portrait": "爆发、执行、利落", "goldSentence": "即使碎了，也要冒着热气。", "match": ["C", "D", "E"], "description": "测出麻婆豆腐的你，生命力正处于极其旺盛的‘沸腾期’。你活得极具颗粒感，讨厌一切拖泥带水和虚情假意。豆腐的碎，象征着你曾经历过的那些足以让你崩溃的瞬间，但你最牛的一点在于：即使被生活揉碎了，你依然要冒着热气，依然要辣出存在感。你的生命里没有‘将就’，爱就爱死，恨就恨死。你是一个侠义心肠的理想主义者，为了朋友或公义，你可以瞬间炸裂。虽然偶尔会因为锋芒太露而灼伤别人，但大家还是忍不住靠近你，因为你身上那种炽热的能量，是这个冷冰冰的世界最缺的燃料。"},
    {"name": "佛跳墙", "portrait": "深沉、复杂、精英", "goldSentence": "别乱猜，我底牌厚着呢。", "match": ["C", "A", "E"], "description": "你是一个巨大的、迷人的谜题。佛跳墙之所以名贵，不在于它的名号，而在于它能将几十种性格迥异的‘阅历’焖在同一个坛子里，却能做到和而不同。你拥有极高的情绪容纳度，生活给你的苦、职场给你的辣、旧时光给你的酸，都被你用一种名为‘理智’的慢火炖成了浓郁的汤汁。你很少向外人剖析自己的心路历程，因为懂你的人不需要解释，不懂你的人根本读不出你这道菜的厚度。你是一个长情且极其自律的精英，外表风平浪静，内心波澜万丈，拥有那种‘泰山崩于前而色不变’的顶级定力。"},
    ...
    {"name": "深夜车仔面", "portrait": "韧性、烟火、随性", "goldSentence": "加什么料，我自己说了算。", "match": ["D", "B", "E"], "description": "你是一个生命韧性极强的‘随遇而安者’。深夜车仔面的魅力在于它的烟火气和极高的自由度——无论生活把你扔进什么样的碗里，你都能自备酱料，活出一份有滋有味。你并不迷信那些高大上的成功学，你更看重此时此刻的一碗面、一场觉、一个能让你笑的人。你的性格里有一种极其宝贵的‘接地气’，这让你在任何逆境中都能快速找回生活的节奏。你活得非常通透：生活是自己的，加什么料，该由自己说了算。你是那种即使在谷底，也能煮出一碗热汤来安慰自己的人，这种自愈能力是你最强大的底牌。"},
    {"name": "臭豆腐", "portrait": "特立、独特、芬芳", "goldSentence": "懂的人，自然闻得到香。", "match": ["A", "D", "C"], "description": "你是那种‘爱者极爱，恨者极恨’的极致存在。臭豆腐的特立独行是你灵魂的旗帜。你从来不指望全世界都能理解你，事实上，你甚至有点享受这种‘不被理解’的孤独感。你的性格底色是坚硬且真实的，你拒绝为了合群而修剪掉身上的棱角。这种极致的个性在平庸的人看来是‘臭’（难以理解），但在懂你的人眼里，那是这世间最珍贵的‘奇香’。你拥有极高的自我认同感，你的快乐不需要建立在他人的评价之上。你是那种即便被孤立，也能在自己的小世界里活得有声有色的奇特灵魂。"},
    {"name": "莲藕排骨汤", "portrait": "时间、迷人、真情", "goldSentence": "不赶时间，我慢火熬真情。", "match": ["B", "C", "E"], "description": "你是一个‘时间的朋友’。莲藕排骨汤的最高境界在于慢火细熬，正如你的性格——越老越迷人，越处越有味。你讨厌现代社会那种快进式的节奏，无论是社交还是恋爱，你都更倾向于一种‘慢调子’。你相信真正的好东西都是需要耐心去交换的。你的理性让你能够抵御短期的诱惑，你的治愈让你对身边的人充满长久的温情。你是一个极好的倾听者和陪伴者，虽然话不多，但总能在关键时刻给人一种厚实的依靠感。你是那种即便世界再乱，也能守住内心一锅温润清汤的人。"},
    {"name": "皮蛋瘦肉粥", "portrait": "治愈、细腻、守候", "goldSentence": "世界很吵，我只在深夜懂你。", "match": ["B", "E", "LEAN"], "description": "你是一个极其安静且细腻的‘治愈系灵魂’。皮蛋瘦肉粥从不争抢餐桌的主位，但它却是每个生病、疲惫或失意的时刻最被渴望的存在。你的温柔是润物无声的，你不擅长激昂的演讲，却极擅长沉默的守候。你总是能敏锐地察觉到身边人的不快乐，并用一种极其得体、不带压力的方式去安慰对方。你更喜欢深夜和雨天，因为那是你和灵魂对话的时间。你是一个‘懂事’到让人心疼的人，习惯于向内消化所有的负能量，只向外展示那一抹温热的白。你是这个嘈杂世界里，最让人安心的一处静谧。"},
    {"name": "避风塘炒蟹", "portrait": "护短、霸气、极简", "goldSentence": "披荆斩棘，只为护短。", "match": ["D", "C", "E"], "description": "你是那种极具保护欲的‘霸道温柔’。避风塘炒蟹的特点是金黄酥脆的蒜茸下藏着极硬的壳和极鲜的肉，这完美复刻了你的性格。你对自己在意的人有着近乎‘护短’的霸气，谁要是动了你的人，你绝对会像带刺的蟹壳一样反击。但在强悍的外表下，你对生活有着极其清醒的认知。你明白弱肉强食的规则，所以你努力让自己变得强大，只是为了在风浪里给身边的人围起一个‘避风塘’。你是一个极其值得信赖的伙伴，你的爱是带有防御性的、充满力量感的。你不需要甜言蜜语，你的每一个动作都在说：‘别怕，有我在。’"},
    {"name": "干煸豆角", "portrait": "干练、利落、直率", "goldSentence": "废话少说，直接干脆。", "match": ["D", "E", "LEAN"], "description": "你是一个讨厌废话的‘高效执行者’。干煸豆角去除了多余的水分，只留下最纯粹的焦香，正如你的人生观——极简、利落、结果导向。你极度反感那些华而不实的修辞和拖拖拉拉的流程。在生活中，你总是那个第一个发现问题并动手解决的人。你的性格里有一种健康的‘自恋’，你相信自己的判断，并且行动力极强。虽然偶尔会因为太过直接而显得不够委婉，但你的真诚和高效让你在任何团队中都是不可或缺的核心。你是一个活得很‘烫’的人，拒绝平庸，拒绝模糊，喜欢那种颗粒分明的清脆感。"},
    {"name": "水煮肉片", "portrait": "沸腾、沧桑、鲜活", "goldSentence": "沸腾过，才叫活过。", "match": ["C", "D", "A", "E"], "description": "你是一个‘底色是辣，活法是烫’的生命斗士。水煮肉片的精髓在于那层滚烫的明油，它封锁住了食材的鲜美，展示出最激烈的沸腾。测出这个结果的你，内心深处一定藏着些鲜为人知的过往，但你拒绝以此示弱。你选择用一种更火热、更积极的方式去面对生活给你的捶打。你是一个极其复杂且迷人的个体，辣的刺激让你察觉真相，烫的理智让你接纳现实，果敢让你冲破黑暗。你的一生都在不断地自我重组和自我超越，对你来说，人生最大的意义不是安稳，而是那种‘沸腾’的痛快感。"},
    {"name": "扬州炒饭", "portrait": "严谨、精致、分明", "goldSentence": "颗粒分明，清白自守。", "match": ["C", "B", "E"], "description": "你是一个追求‘秩序感’的精致主义者。扬州炒饭讲究颗粒分明，配料精准，正如你的生活哲学——边界清晰，拒绝模糊。你极度重视个人空间和隐私，讨厌那种毫无界限感的冒犯。你拥有一种近乎强迫症的审美，无论是桌面还是人生轨迹，你都希望它们是井然有序的。这种‘颗粒感’让你在社交中保持着一种恰到好处的疏离和礼貌。你并不高冷，你只是更倾向于用一种克制的、文明的方式去表达情感。你是一个极其可靠的人，答应过的事一定会做到，你的世界里没有‘大概’ and ‘也许’，只有分毫必争的精准和清白。"},
    {"name": "东坡肉", "portrait": "稳重、丰盈、从容", "goldSentence": "厚积薄发，不紧不慢。", "match": ["B", "D", "E"], "description": "你是一个拥有‘钝感力’的智者。东坡肉的成功在于‘慢火焖’，这正是你的人生节奏——稳重丰盈，从容不迫。在这个被焦虑感驱动的时代，你依然能保持那种‘厚积薄发’的定力。你拥有一种极具福报的性格，看淡名利，却能最终获得名利；不紧不慢，却总能走在前面。你的生命厚度来自于你对美好的感知力和对目标的坚持力。你是一个极其宽厚的人，能够包容他人的愚蠢或冒犯，就像这块肉总能包容调料的侵略。这种从容不迫的生命状态，是你对浮躁世界最优雅对抗。"},
    {"name": "开水白菜", "portrait": "极致、深厚、淡然", "goldSentence": "最高级的清淡，最深的底蕴。", "match": ["C", "RARE"], "description": "这是一个极其稀有的灵魂。开水白菜看似清如白水，实则是用无数山珍海味提炼后的极简。测出这个结果的你，已经进入了那种‘返璞归真’的境界。你的外表极其平和，甚至有些寡淡，但你的内心世界却深邃如海。你已经不再需要向外界炫耀任何东西，因为你所有的底气都内化成了那种淡然自若的气场。你拥有一种高级的清醒，能看穿所有的浮华，却依然愿意拥抱生活最本质的平淡。你是那种‘大隐隐于市’的人物，看似平凡的一叶菜心，实则承载着整座森林的底蕴和智慧。"},
...
def calculate_dish_result(scores):
    ...
    top1_dim, top1_val = sorted_scores[0]
    top2_dim, top2_val = sorted_scores[1]
    min_val = sorted_scores[-1][1]

    # --- 1. 隐藏款抽奖 (5% 概率强制触发速冻水饺) ---
    if random.random() < 0.05:
        hidden_dish = next((d for d in DISH_RESULTS if "HIDDEN" in str(d['match'])), None)
        if hidden_dish: return hidden_dish, percentages

    # --- 2. 判定【一碗白米饭】 (绝对均衡：极差 <= 2) ---
    if (top1_val - min_val) <= 2:
        return next(d for d in DISH_RESULTS if 'BALANCED' in d['match']), percentages

    # --- 3. 判定【极致/稀有】 (第一名领先第二名 4 分以上) ---
    if (top1_val - top2_val) >= 4:
        # 寻找包含 Top1 维度 且 带有 EXTREME 或 RARE 标识的菜
        extreme_candidates = [
            d for d in DISH_RESULTS 
            if top1_dim in str(d['match']) and ("EXTREME" in str(d['match']) or "RARE" in str(d['match']))
        ]
        if extreme_candidates:
            return random.choice(extreme_candidates), percentages

    # --- 4. 判定【Top1 + Top2 组合】 (最常用的匹配) ---
    # 建立候选池，解决概率公平问题
    candidates = []
    for dish in DISH_RESULTS:
        m_str = str(dish['match'])
        # 只要 Top1 和 Top2 都在该菜品的 match 标签里，就入选
        if top1_dim in m_str and top2_dim in m_str:
            candidates.append(dish)

    if candidates:
        return random.choice(candidates), percentages

    # --- 5. 判定【Top 1 单维度兜底】 (防止某些组合没写导致的报错) ---
    # 比如你没写 "A"和"E" 的组合菜，那就从所有带 "A" 的菜里抽一个
    fallback_pool = [d for d in DISH_RESULTS if top1_dim in str(d['match'])]
    if fallback_pool:
        return random.choice(fallback_pool), percentages

    # --- 6. 终极兜底 (防止列表为空) ---
    return DISH_RESULTS[0], percentages
